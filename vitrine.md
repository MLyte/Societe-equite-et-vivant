...
contribution: |
  **Vos compétences peuvent faire avancer le modèle.**
  ...
  [Voir comment contribuer](#approfondir)
inspirations:
  title: Des pistes pour penser autrement
  intro: "Garantir une vie digne, préserver le vivant et donner une place au temps long : **plusieurs démarches explorent déjà ces questions**. Voici quelques références pour prolonger la réflexion."
  reserve: "Ces références éclairent certains aspects du projet. Elles n’impliquent ni partenariat, ni soutien, ni accord sur l’ensemble du modèle."
  cards:
    - title: The Shift Project
      category: Inspiration déjà recensée
      text: "Penser la décarbonation comme une **transformation d’ensemble** : énergie, alimentation, logement, mobilité et emploi. Ses travaux inspirent la recherche de **trajectoires chiffrées, cohérentes entre secteurs** et ancrées dans les contraintes physiques."
      url: https://theshiftproject.org/qui-sommes-nous/
      language: fr
      link: Découvrir leurs travaux
    - title: L’économie du Doughnut
      category: Cadre de réflexion
      text: Répondre aux besoins de chacun sans dépasser les limites de la planète. Un cadre qui rapproche **justice sociale et conditions écologiques**.
      url: https://doughnuteconomics.org/doughnut
      language: en
      link: Découvrir le modèle
    - title: Les générations futures au pays de Galles
      category: Inspiration déjà recensée
      text: Donner une **place institutionnelle aux personnes qui vivront après nous**. Le commissaire accompagne et interpelle les organismes publics sur leurs engagements de long terme.
      url: https://futuregenerations.wales/do/get-in-touch/faqs/
      language: en
      link: Découvrir cette institution
    - title: Democracy International
      category: Association à découvrir
      text: Renforcer la **participation citoyenne aux décisions**, y compris à l’échelle européenne. Une démarche à explorer pour dépasser le seul rendez-vous électoral.
      url: https://consul.democracy-international.org/the-future-of-european-democracy?projekt_phase_id=2
      language: en
      link: Découvrir leurs initiatives
---
...
à contribuer peuvent employer des paragraphes simples.
Un Quoi ? facultatif peut suivre pour nommer le mécanisme prévu dans le projet,
sans répéter la méthode du Comment ?. S'appuyer sur le chapitre cité.
Les exemples des Pourquoi ? relient un constat daté et sourcé au principe
défendu, sans attribuer automatiquement ce constat à une cause unique. -->
...
**Pourquoi ?** À l’échelle mondiale, les politiques climatiques évaluées en 2025 **restaient insuffisantes pour respecter l’accord de Paris** ([ONU Environnement](https://www.unep.org/resources/emissions-gap-report-2025)). Le projet veut protéger durablement humains, espèces et écosystèmes.
...
[En savoir plus : le vivant](docs/07-environnement.md)

### Relier dignité, équité et durabilité

**Pourquoi ?** En 2025, **8,8 % de la population de l’Union européenne ne pouvait pas chauffer suffisamment son logement** ([Commission européenne](https://energy.ec.europa.eu/topics/markets-and-consumers/energy-consumers-and-prosumers/energy-poverty_en)). Une transition durable doit permettre de vivre dignement.
...
[En savoir plus : le socle vital](docs/04-socle-vital.md)

[En savoir plus : le partage des richesses](docs/05-economie.md)
...
[En savoir plus : la préparation aux crises](docs/19-securite-civile-crises.md)

[En savoir plus : les transformations économiques](docs/05-economie.md)
...
[En savoir plus : l’IA et les arbitrages de long terme](docs/08-ia.md)
...
[En savoir plus : le financement](docs/15-finance-dette-investissement.md)
...
[En savoir plus : la transition](docs/11-transition.md)

### Tester les propositions ensemble

**Pourquoi ?** Pour vérifier la **cohérence entre secteurs**.

**Comment ?** Tester des **scénarios défavorables**, puis des expérimentations limitées avec indicateurs publics, conditions d’arrêt et décision démocratique avant généralisation.

[En savoir plus : les expérimentations](docs/11-transition.md#phase-3--expérimentations-locales)

[En savoir plus : l’évaluation](docs/18-indicateurs-audits.md)
...
[En savoir plus : l’origine du projet](README.md#pourquoi-ce-projet-)
...
[Signaler une piste ou un problème](https://github.com/MLyte/Societe-equite-et-vivant/issues/new)

[Proposer une modification : le guide](CONTRIBUTING.md)
